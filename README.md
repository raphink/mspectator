...
* The `MCollective::RPC#rpcclient` object would be shared between examples, and `reset` would be called before each example group. This would allow to do only one `discover` per example group.
